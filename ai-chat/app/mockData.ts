...
export const mockMessages: Message[] = [
  {
    id: '1',
    agentId: 'elementary',
    content: 'うーん、これってどういうことなんだろう？みんなで一緒に考えてみよう！',
  ...
  },
  {
    id: '2',
    agentId: 'developer',
    content: '技術的な観点から分析すると、まずはアーキテクチャの設計が重要ですね。スケーラビリティを考慮した実装が必要です。',
  ...
  },
  {
    id: '3',
    agentId: 'chuuni',
    content: 'フッ...この程度の問題など、我が深淵なる知識の前では些細なことに過ぎない。真の解決策を教えてやろう。',
  ...
  },
  {
    id: '5',
    agentId: 'pm',
    content: 'ユーザーのニーズを考えると、MVPとして最小限の機能から始めるのが良いでしょう。データを見ながら段階的に改善していきます。',
  ...
  },
  {
    id: '6',
    agentId: 'devil',
    content: 'ちょっと待て、そんな甘い考えで大丈夫か？リスクを見落としてないか？失敗したときのことも考えろよ。',
  ...
  messages: [
    {
      id: '10',
      agentId: 'pm',
      content: 'リモートワークの効率化は、コミュニケーションとタスク管理が鍵になります。',
...
export const generateMockResponse = (agentId: string, question: string): string => {
